...
def index():
    ...
    business_source = get_sources('general')
    ...
    return render_template('index.html', title = title, general = general_source, business = business_source, technology = technology_source, sports = sports_source, entertainment = entertainment_source, health = health_source, science = science_source)
